...
> **Git Hooks**: If you have pre-commit hooks (like conventional commits or linters) that interfere with epicd's automated commits, set `bypassGitHooks: true` to skip them using the `--no-verify` flag.
