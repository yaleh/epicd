---
name: epicd-run
description: "Arm the autonomous epicd worker: one persistent Monitor running scan-loop.cjs against the epicd board. Act on each emitted event block. Invoke once per session. Stop: touch backlog/.loop-stop"
