...
const Navigation: React.FC<NavigationProps> = ({projectName}) => {
    return (
        <nav className="pl-16 pr-8 md:px-8 h-18 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 transition-colors duration-200">
            <div className="h-full flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <a
                        href="https://github.com/yaleh/epicd"
                        target="_blank"
