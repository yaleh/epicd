/**
 * BACK-654 — Phase C: the lightweight-path experiment's "known deviation"
 * record for the BACK-649/BACK-653 adjudicate/dodResults mismatch must be
 * updated to reflect that the defect is now fixed, not left describing it
 * as an unresolved open defect.
 *
 * This record originally lived in docs/research/baime-fixpoint-convergence/
 * README.md; it was migrated (along with the rest of the lightweight-path
 * skeleton, execution table, and retrospectives) to the sibling
 * docs/research/lightweight-fixpoint/README.md when that sub-experiment
 * was split out into its own directory.
 */
...
const README_PATH = join(process.cwd(), "docs", "research", "lightweight-fixpoint", "README.md");

describe("BACK-654 doc update: lightweight-fixpoint README", () => {
