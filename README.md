...
## 📊 Backlog.md Project Status (v1.6.11)

This board was automatically generated by [Backlog.md](https://backlog.md)

Generated on: 2025-08-03 16:53:50

| To Do | In Progress | Done |
| --- | --- | --- |
| **TASK-222** - Improve task and subtask visualization in web UI | └─ **TASK-24.1** - CLI: Kanban board milestone view [@codex] | **TASK-211** - Add version number display to browser UI<br>*#ui #frontend #enhancement* |
| **TASK-217** - Create web UI for sequences with drag-and-drop<br>*#sequences #web-ui #frontend* |  | **TASK-212** - Improve board export UI formatting and readability<br>*#formatting #dx #cli* |
| **TASK-216** - Add server API endpoints and web UI for sequences<br>*#sequences #api #backend #web-ui #frontend* |  | **TASK-206** - Order done column by updatedDate in board export<br>*#board #export #sorting* |
| **TASK-215** - Implement TUI view for sequences<br>*#sequences #tui #ui* |  | **TASK-221** - Add favicon to web interface |
| **TASK-214** - Add CLI command to list sequences (plain text output)<br>*#sequences #cli* |  | **TASK-220** - Fix Helix editor integration with proper TUI suspension [@claude] |
...
| **TASK-208** - Add paste-as-markdown support in Web UI<br>*#web-ui #enhancement #markdown* |  | **TASK-219** - Refactor server component to fix separation of concerns violations<br>*#refactoring #architecture #server* |
| **TASK-200** - Add Claude Code integration with workflow commands during init<br>*#enhancement #developer-experience* |  | **TASK-210** - Refactor Nix packaging to build node_modules offline<br>*#nix #build #packaging* |
