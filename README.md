...
## 📊 Backlog.md Project Status (v1.11.0)
...
| **TASK-260** - Web UI: Add filtering to All Tasks view [@codex]<br>*#web-ui #filters #ui* | └─ **TASK-24.1** - CLI: Kanban board milestone view [@codex] | **TASK-261** - Init: Handle missing git origin gracefully [@codex]<br>*#cli #git #init #bug* |
