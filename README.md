...
| **TASK-214** - Add CLI command to list sequences (plain text output)<br>*#sequences #cli* |  | **TASK-221** - Add favicon to web interface |
| **TASK-213** - Compute sequences from task dependencies<br>*#sequences #core* |  | **TASK-220** - Fix Helix editor integration with proper TUI suspension [@claude] |
| **TASK-208** - Add paste-as-markdown support in Web UI<br>*#web-ui #enhancement #markdown* |  | **TASK-175** - Add hour and minute to all dates in drafts, tasks, documents, decisions [@claude] |
| **TASK-200** - Add Claude Code integration with workflow commands during init<br>*#enhancement #developer-experience* |  | **TASK-219** - Refactor server component to fix separation of concerns violations<br>*#refactoring #architecture #server* |
