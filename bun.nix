...
}:
{
  ...
  "@csstools/css-syntax-patches-for-csstree@1.0.20" = fetchurl {
  ...
  "@modelcontextprotocol/sdk@1.24.2" = fetchurl {
  ...
  "@tailwindcss/cli@4.1.17" = fetchurl {
  ...
  "@uiw/react-md-editor@4.0.10" = fetchurl {
  ...
  "react-router-dom@7.10.0" = fetchurl {
